...
export const SidebarContainer = tw.aside`glass-surface fixed top-0 left-0 z-999 hidden min-h-screen flex-col items-center justify-between gap-6 border-r border-secondary-1 p-4 text-base-font drop-shadow-sidebar transition-all duration-300 ease-in-out lg:flex`;
