...
export const Header = tw.div`glass-strong sticky top-0 z-99 flex h-18.5 items-center justify-between gap-2 px-4 py-2 !text-sm font-semibold text-base-font`;
...
export const SwipeControls = tw.div`glass-strong sticky top-18.5 z-90 flex items-center justify-between gap-2 p-2 shadow-xl`;
