...
export const RowsPerPageSelect = tw.select`glass-field rounded-md border border-secondary-1 p-1 text-xs focus:border-secondary-1 focus:ring-0 focus:outline-none sm:text-sm`;
