...
export const MenuIcon: FC<React.SVGProps<SVGSVGElement>> = ({
  ...
  <svg
    width={width}
    height={height}
    className="text-base-font hover:cursor-pointer hover:text-neutral-500"
    viewBox="0 -5 32 32"
    version="1.1"
    xmlns="http://www.w3.org/2000/svg"
  >
...
export const SettingsIcon: FC<React.SVGProps<SVGSVGElement>> = ({
  width = 20,
  height = 20,
  className,
}) => (
...
export const EnIcon: FC<React.SVGProps<SVGSVGElement>> = ({
  width = 18,
  height = 18,
  className,
}) => (
...
export const RuIcon: FC<React.SVGProps<SVGSVGElement>> = ({
  width = 18,
  height = 18,
  className,
}) => (
...
export const FrIcon: FC<React.SVGProps<SVGSVGElement>> = ({
  width = 18,
  height = 18,
  className,
}) => (
