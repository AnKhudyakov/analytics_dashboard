...
export const Content = tw.div`glass-panel flex h-full max-h-60 w-full max-w-120 flex-col items-center justify-center gap-6 rounded-panel p-8 text-center`;
